...
import { unichain, telos, polygon, moonbeam, avalanche, mantaTestnet, manta, mainnet, bscTestnet, sepolia, base, bsc, arbitrum, arbitrumGoerli } from "wagmi/chains";
...
export const config: any = createConfig({
  chains: [unichain, telos, polygon, moonbeam, avalanche, mantaTestnet, manta, mainnet, bscTestnet, sepolia, base, bsc, arbitrum, arbitrumGoerli], //poolz chains
