...
export type ContractReadSchemas = {
  ...
  StakingManager: {
    'DECIMALS_OFFSET': readonly [];
    'MAX_FEE_RATE': readonly [];
    'UPGRADE_INTERFACE_VERSION': readonly [];
    'allowance': readonly [owner: `0x${string}`, spender: `0x${string}`];
    'asset': readonly [];
    'balanceOf': readonly [account: `0x${string}`];
    'convertToAssets': readonly [shares: bigint];
    'convertToShares': readonly [assets: bigint];
    'decimals': readonly [];
    'getMigrationInfo': readonly [newVault: `0x${string}`];
    'inputFeeRate': readonly [];
    'maxDeposit': readonly [`0x${string}`];
    'maxMint': readonly [`0x${string}`];
    'maxRedeem': readonly [owner: `0x${string}`];
    'maxWithdraw': readonly [owner: `0x${string}`];
    'name': readonly [];
    'outputFeeRate': readonly [];
    'owner': readonly [];
    'paused': readonly [];
    'previewDeposit': readonly [assets: bigint];
    'previewMint': readonly [shares: bigint];
    'previewRedeem': readonly [shares: bigint];
    'previewWithdraw': readonly [assets: bigint];
    'proxiableUUID': readonly [];
    'stakingVault': readonly [];
    'symbol': readonly [];
    'totalAssets': readonly [];
    'totalFeeAssets': readonly [];
    'totalFeeShares': readonly [];
    'totalSupply': readonly [];
...
export type ContractWriteSchemas = {
  ...
  StakingManager: {
    ...
    'deposit': readonly [assets: bigint, receiver: `0x${string}`];
    'initialize': readonly [_stakingVault: `0x${string}`, name: string, symbol: string, owner: `0x${string}`];
    'migrateVault': readonly [newVault: `0x${string}`];
    'mint': readonly [shares: bigint, receiver: `0x${string}`];
    'pause': readonly [];
    'redeem': readonly [shares: bigint, receiver: `0x${string}`, owner: `0x${string}`];
    'renounceOwnership': readonly [];
    ...
    'withdraw': readonly [assets: bigint, receiver: `0x${string}`, owner: `0x${string}`];
    'withdrawFeeShares': readonly [recipient: `0x${string}`, shares: bigint];
  };
  TimedDealProvider: {
    'acceptFirewallAdmin': readonly [];
    'beforeTransfer': readonly [from: `0x${string}`, to: `0x${string}`, poolId: bigint];
...
export type ContractReturnTypes = {
  ...
  StakingManager: {
    ...
    'decimals': bigint;
    'deposit': bigint;
    'getMigrationInfo': [bigint, bigint, bigint, bigint];
    'initialize': void;
    'inputFeeRate': bigint;
    'maxDeposit': bigint;
    'maxMint': bigint;
