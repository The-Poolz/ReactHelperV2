...
export type ContractReturnTypes = {
  ...
  DelayVault: {
    ...
    'GetUsersDataByRange': [`0x${string}`[], any[]];
  ...
  LockedDealV2: {
    ...
    'Fee': bigint;
    'FeeToken': `0x${string}`;
    'GetAllMyPoolsData': any[];
    'GetAllMyPoolsId': bigint;
    'GetMyPoolDataByToken': [any[], bigint];
    'GetMyPoolsData': any[];
    'GetMyPoolsId': bigint;
...
export const contractNames = ['DaoStation', 'DealProvider', 'DelayVault', 'DelayVaultMigrator', 'DelayVaultProvider', 'DispenserProvider', 'InvestProvider', 'LockDealNFT', 'LockDealProvider', 'LockedDealV2', 'MultiSenderV2', 'SimpleBuilder', 'StakingManager', 'TimedDealProvider', 'TokenNFTConnector', 'VaultManager'] as const;
